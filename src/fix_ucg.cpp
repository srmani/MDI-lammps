...
#define PI 3.14159
/* ---------------------------------------------------------------------- */
FixUCG::FixUCG(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp,narg,arg)
{
...
/* ---------------------------------------------------------------------- */
void FixUCG::find_initialstatedistribution()
{
...
/* ---------------------------------------------------------------------- */
void FixUCG::init_list(int id, NeighList *ptr)
{
  list = ptr;
}

/* ---------------------------------------------------------------------- */
void FixUCG::setup(int vflag)
{
...
/* ---------------------------------------------------------------------- */
void FixUCG::post_force_respa(int vflag, int ilevel, int iloop)
{
...
void FixUCG::normalize(double *a)
{
  double mag=0.0;
  for(int k=0;k<3;k++)
    mag += a[k]*a[k];
...
void FixUCG::computecross(double *a, double *b1, double *b2)
{
...
double FixUCG::computedot(double *b1, double *b2)
{
...
double FixUCG::computedihedral(double *x1, double *x2, double *x3, double *x4)
{
...
/* ---------------------------------------------------------------------- */
void FixUCG::rotatepointalongaxisbyangle(double *q, double *p, double theta, double *r)
{
...
/* ---------------------------------------------------------------------- */
void FixUCG::post_force(int vflag)
{
  //VARIABLES//
...
/* ---------------------------------------------------------------------- */
int FixUCG::pack_forward_comm(int n, int *list, double *buf, int pbc_flag, int *pbc)
{
  int *type = atom->type;
  double **x = atom->x;
  int m=0,k;
...
/* ---------------------------------------------------------------------- */
void FixUCG::unpack_forward_comm(int n, int first, double *buf)
{
  int last=first+n;
  int m=0;
  int *type = atom->type;
...
/* ---------------------------------------------------------------------- */
double FixUCG::memory_usage()
{
  return 0;
}

/* ---------------------------------------------------------------------- */
void FixUCG::reset_accumulators()
{
  for(int imol=0;imol<nmol+1;imol++)
    {
      trans_flag[imol]=0;
...
/*------------------------------------------------------------------------*/
int FixUCG::getnewatomtype(int imol, int itype, int ispecies)
{
